  ...
  return (
    <section className={styles.wordArchive} aria-label="Membrana de las palabras">
      ...
      <section className={styles.assemblyTable} aria-label="Mesa de montaje">
        ...
        ) : <p className={styles.assemblyEmpty}>Pulsa ＋ junto a cualquier forma de la membrana. Aquí no se borra nada: solo preparas una secuencia.</p>}
        <footer>
          <button type="button" disabled={!assembly.length} onClick={() => onAssemble(assembly)}>LLEVAR SECUENCIA AL CAMPO DE ESCRITURA ↗</button>
