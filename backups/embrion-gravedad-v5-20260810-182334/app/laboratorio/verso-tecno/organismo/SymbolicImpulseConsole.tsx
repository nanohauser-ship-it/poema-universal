...
import { extractWritingWords } from "@/lib/embrion/symbolic-engine";
    ...
    <section className={styles.symbolicConsole} aria-label="Campo de gravedad simbólica">
      <header>
        <div>
          ...
          <small>ARCHIVO SIMBÓLICO · IMPULSOS DE ESCRITURA</small>
        </div>
      ...
      <div className={styles.nucleusChooser}>
        <span>ELIGE QUÉ PALABRA EJERCE GRAVEDAD</span>
        {words.length ? (
          <div>
            {words.map((word) => (
              <button
