...
function fallbackResponse(brief: ScenographyBrief) {
  return NextResponse.json(
    { blueprint: generateLocalBlueprint(brief), source: "fallback" },
    {
      headers: {
