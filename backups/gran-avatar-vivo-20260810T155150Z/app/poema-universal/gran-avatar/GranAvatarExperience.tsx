...
export default function GranAvatarExperience() {
  ...
  >([
    makeMessage(
      "assistant",
      "Estoy aquí. Entrégame un poema y lo leeré antes de responder.",
    ),
  ]);
  ...
  const playVoice = useCallback(
    async (text: string, mode: VoiceMode) => {
      ...
      setNotice(
        mode === "reading"
          ? "La voz se prepara para habitar el poema."
          : "La presencia prepara su respuesta.",
      );
  ...
  async function submitMessage() {
    if (!currentPoem || !messageDraft.trim()) return;
    ...
    if (
      ...
      setNotice(
        currentPoem
          ...
          : "Carga primero un poema para comenzar la conversación.",
      );
      return;
    }
    ...
    <main className={styles.page}>
      ...
      <div className={styles.experienceGrid}>
        ...
        <section id="avatar" className={styles.avatarStage}>
          ...
          <AvatarBody media={GRAN_AVATAR_MEDIA} state={presenceState} />

          <div className={styles.avatarTelemetry} aria-label="Estado del avatar">
            <dl>
              <div>
                <dt>Estado</dt>
                <dd>{STATE_LABELS[presenceState]}</dd>
              </div>
              <div>
                <dt>Memoria</dt>
          ...
          <div className={styles.readingControls}>
            ...
            <button
              ...
              onClick={togglePause}
            >
              {presenceState === "paused" ? "Continuar" : "Pausar"}
            </button>
            <button type="button" onClick={cyclePlaybackRate}>
        ...
        <aside className={styles.conversationPanel} aria-labelledby="conversation-title">
          ...
          <div className={styles.messageComposer}>
            ...
            <button
              type="button"
              disabled={!currentPoem || !messageDraft.trim()}
