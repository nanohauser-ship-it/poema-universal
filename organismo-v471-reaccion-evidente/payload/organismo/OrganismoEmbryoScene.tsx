  ...
  useEffect(() => {
    ...
    function animate(timestamp?: number) {
      ...
      const targetBodyScale =
        0.96 +
        feeding.biomasaVerbal * 0.48 +
        keyShock * 0.055 +
        absorptionShock * 0.16 -
        deletionShock * 0.075;
      const smoothBodyScale =
        root.scale.x + (targetBodyScale - root.scale.x) * 0.085;
      ...
      const targetCameraZ =
        4.65 - feeding.biomasaVerbal * 0.58 - absorptionShock * 0.16;
