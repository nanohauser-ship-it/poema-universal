...
export function BestiarioPoetico() {
  ...
  const [detectedModelUrl, setDetectedModelUrl] = useState<
    string | undefined
  >();
  ...
  async function playCreatureVoice() {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          data.error || "No se pudo crear la voz de la criatura."
        );
      }
      ...
      audio.addEventListener("error", () => {
        setVoicePlaying(false);
        setVoiceError("No fue posible reproducir la voz.");
      });
      ...
      setVoiceError(
        cause instanceof Error
          ? cause.message
          : "No fue posible escuchar la voz."
      );
    } finally {
      setVoiceLoading(false);
    }
  ...
  async function revealCreature() {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.error || "No se pudo revelar la criatura."
        );
      }
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        <p className={styles.eyebrow}>
          Matriz Poética · Cámara de la criatura
        </p>

        <h1>Bestiario Poético</h1>

        <p className={styles.lead}>
          Cada poema contiene una presencia. Aquí no se ilustra el
          texto: se revela su criatura, su reliquia, su oráculo y la
          anatomía necesaria para existir en tres dimensiones.
        </p>
      ...
      <section className={styles.workspace}>
        <div className={styles.formPanel}>
          ...
          <div className={styles.counter}>
            {count.toLocaleString("es-ES")} / 18.000
          </div>
          ...
          <label className={styles.label}>
            ...
            <textarea
              ...
              value={authorContext}
              onChange={(event) =>
                setAuthorContext(event.target.value)
              }
              maxLength={1_200}
          ...
          >
            {loading
              ? "La criatura está tomando forma…"
              : "Revelar la criatura"}
          </button>
        ...
        <aside className={styles.lawPanel}>
          ...
          <blockquote>
            “La criatura no decora el poema. Muestra aquello que el
            poema todavía no sabe nombrar.”
          </blockquote>

          <dl>
            <div>
              <dt>Lectura</dt>
              <dd>Herida, deseo, tensión y gesto.</dd>
            </div>

            <div>
              <dt>Revelación</dt>
              <dd>Nombre, linaje, materia y hábitat.</dd>
            </div>

            <div>
              <dt>Consagración</dt>
              <dd>
                Lámina, reliquia, oráculo y presencia 3D.
              </dd>
            </div>
          </dl>
        </aside>
      ...
      {reveal && (
        ...
        >
          ...
          <nav
            ...
            aria-label="Vistas de la criatura"
          >
            <button
              type="button"
              data-active={view === "plate"}
          ...
          {view === "plate" && (
            <article className={styles.generatedPlate}>
              <div
                className={styles.plateHalo}
                aria-hidden="true"
              />

              <p className={styles.plateBrand}>
                Bestiario Poético
              </p>

              <h3>{reveal.name}</h3>

              <p className={styles.symbolicCore}>
                {reveal.symbolicCore}
              </p>

              <div
                className={styles.creatureSigil}
                aria-hidden="true"
              >
                ✦
              </div>
              ...
              <dl className={styles.plateData}>
                <div>
                  <dt>Linaje</dt>
                  <dd>{reveal.lineage}</dd>
                </div>

                <div>
                  <dt>Materia</dt>
                  <dd>{reveal.matter.join(", ")}</dd>
                </div>

                <div>
                  <dt>Hábitat</dt>
                  <dd>{reveal.habitat}</dd>
                </div>

                <div>
                  <dt>Gesto</dt>
                  <dd>{reveal.gesture}</dd>
                </div>
              ...
              <section
                className={styles.voiceChamber}
                aria-labelledby="voz-criatura"
              >
                <p className={styles.voiceLabel}>
                  Lo que la criatura te diría
                </p>
                ...
                <p className={styles.voicePhrase}>
                  “{reveal.voice.phrase}”
                </p>

                <p className={styles.voiceTone}>
                  {reveal.voice.tone}
                </p>
            ...
            <div className={styles.modelPanel}>
              ...
              <div className={styles.modelNote}>
                <p>
                  ...
                  <code>
                    /public/models/bestiario/{reveal.slug}.glb
                  </code>
                </p>

                <p>
                  Mientras el archivo GLB no exista, la cámara
                  muestra el núcleo provisional de la criatura.
                </p>
              </div>
            </div>
          )}
          ...
          {view === "brief" && (
            <div className={styles.briefGrid}>
              <article>
                <span>Silueta</span>
                <p>
                  {reveal.modelingBrief.silhouette}
                </p>
              </article>
              ...
              <article>
                <span>Reposo</span>
                <p>
                  {reveal.modelingBrief.idleAnimation}
                </p>
              </article>
              ...
              <article>
                <span>Aparición</span>
                <p>
                  {reveal.modelingBrief.revealAnimation}
                </p>
              </article>
              ...
              <article className={styles.wideBrief}>
                <span>Entorno</span>
                <p>
                  {reveal.modelingBrief.environment}
                </p>
              </article>
              ...
              <article className={styles.wideBrief}>
                ...
                <ul>
                  {reveal.modelingBrief.meshNotes.map(
                    (note) => (
                      <li key={note}>
                        {note}
                      </li>
