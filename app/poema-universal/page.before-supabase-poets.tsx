...
const POET_PROFILES: Record<number, PoetProfile> = {
  1: {
    position: 1,
    name: "José Naveiro",
    country: "España",
  ...
  2: {
    position: 2,
    name: "Identidad en incorporación",
    country: "Chile",
    status: "incorporation",
    shortBio:
      "Esta voz ha comenzado su incorporación a Poema Universal. Su nombre, trayectoria y breve biografía aparecerán cuando el perfil haya sido completado y autorizado para su publicación.",
  },
  3: {
    position: 3,
    name: "Identidad en incorporación",
        ...
        >
          ...
          <ol className="mt-20 grid grid-cols-2 border-l border-t border-white/[0.16] sm:grid-cols-3 lg:grid-cols-6">
            {voiceSlots.map((slot) => {
              ...
              const poetProfile =
                POET_PROFILES[slot.position] ?? null;
