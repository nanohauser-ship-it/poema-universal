...
export const pieces: WorldPiece[] = [
...

  {
    ...
    phrase:
      "Abre los ojos como quien regresa de un mar que nadie más recuerda.",
    kind: "awakening",
    position: [-2.3, -2.15],
    rotation: 0.18,
    scale: 0.9,
  },
  {
    ...
    archetype: "Tránsito · llegada · rescate",
    phrase:
  ...
  },
  {
    ...
    phrase:
      "Lo perdido continúa buscando la forma exacta de su otra mitad.",
    kind: "heart",
    position: [-2.25, 2.15],
    rotation: -0.12,
    scale: 0.92,
  },
  {
    ...
    world: "bielka",
    number: "III · 04",
    name: "La Ausencia Blanca",
    archetype: "Laberinto · presencia · revelación aplazada",
    phrase:
      "Algo respira detrás del blanco, pero todavía no debe ser visto.",
    kind: "void",
    position: [2.25, 2.15],
    rotation: 0.12,
    scale: 0.9,
