  ...
  return (
    <section className="relative min-h-[900px] overflow-hidden bg-[#07090c] text-[#f0e8dc]">
      ...
      <div className="pointer-events-none relative z-10 mx-auto flex min-h-[900px] max-w-[1550px] flex-col justify-between px-5 py-10 sm:px-8 lg:px-12">
        <div className="flex flex-col gap-6 border-b border-white/10 pb-7 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="max-w-lg">
            <p className="text-sm leading-7 text-white/42">
              Tres tableros, doce piezas y una memoria que
        ...
        <div className="pointer-events-none flex min-h-[220px] items-end">
          {activePiece ? (
            <article className="pointer-events-auto max-w-xl border border-white/12 bg-black/45 p-6 backdrop-blur-xl sm:p-8">
              <div className="flex items-start justify-between gap-8">
                <div>
                  <p
                    ...
                    style={{
                      color:
                        worldById[activePiece.world]
                          .accent,
                    }}
                  >
                    Pieza {activePiece.number}
                  </p>

                  <h3 className="mt-4 font-serif text-3xl leading-none tracking-[-0.04em] text-white sm:text-4xl">
                    {activePiece.name}
                  </h3>
                </div>
                ...
                {selectedPieceId && (
                  <button
                    ...
                    className="text-[8px] uppercase tracking-[0.25em] text-white/38 transition hover:text-white"
                  >
                    Cerrar
                  </button>
                )}
              ...
              <p className="mt-5 text-[7px] uppercase tracking-[0.25em] text-white/34">
              ...
              {!selectedPieceId && (
                <p className="mt-6 text-[7px] uppercase tracking-[0.25em] text-white/28">
                  Pulsa la pieza para conservarla abierta
                </p>
              )}
            </article>
          ) : (
            <p className="border-l border-white/12 pl-5 text-[8px] uppercase tracking-[0.3em] text-white/28">
              Acércate a una de las doce piezas
            </p>
          )}
        </div>
