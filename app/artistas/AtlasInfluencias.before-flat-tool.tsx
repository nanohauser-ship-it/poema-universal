            ...
            {filteredArtists.map((artista, index) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-6 sm:p-8">
                  ...
                  {(artista.posicion_mirada ||
                    artista.tension_etica) && (
                    <div className="mt-8 border-t border-stone-900/15 pt-7">
                      <p className="text-[7px] uppercase tracking-[0.27em] text-[#9a743e]">
                        Ética de la mirada
                      </p>
                  ...
                  <div className="mt-auto pt-9">
                    <div className="border-t border-stone-900/15 pt-6">
                      ...
                      <p className="mt-3 font-serif text-base italic leading-7 text-stone-500">
                        {artista.dedicatoria ||
                          "Para quien ayudó a mirar el mundo de otra manera."}
                      </p>
                    </div>
