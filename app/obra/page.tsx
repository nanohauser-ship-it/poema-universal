      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <section className="relative mt-28">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-7 max-w-3xl font-serif text-3xl italic leading-[1.35] tracking-[-0.025em] text-stone-800 sm:text-4xl">
              Memoria, hambre y laberinto:
              <br />
              tres formas de atravesar una misma pérdida.
            </p>
          </div>
          ...
          <div className="relative mx-auto max-w-[1280px]">
            ...
            <div className="relative grid items-end gap-0 lg:grid-cols-[1fr_1.08fr_1fr]">
              <article
                className="group relative min-h-[760px] overflow-hidden border-[3px] border-[#8f6f42] bg-[#281f18] shadow-[0_34px_95px_rgba(60,38,19,0.25)]"
                style={{
                  clipPath:
                    "polygon(0 10%, 8% 0, 92% 0, 100% 10%, 100% 100%, 0 100%)",
                }}
              >
                <div
                  aria-hidden="true"
                ...
                <div className="relative z-10 flex min-h-[760px] flex-col justify-end px-8 pb-10 pt-28 sm:px-10">
                  ...
                  <h3 className="mt-6 max-w-full font-serif text-[2rem] font-semibold leading-[0.96] tracking-[-0.045em] text-white sm:text-[2.55rem]">
                    No dejes que
                    <br />
                    desaparezcamos
                  </h3>
              ...
              <article
                className="group relative z-10 min-h-[860px] overflow-hidden border-[4px] border-[#9e7338] bg-[#120c08] shadow-[0_48px_140px_rgba(0,0,0,0.46)] lg:-mx-2 lg:-translate-y-7"
                style={{
                  clipPath:
                    "polygon(0 13%, 17% 0, 83% 0, 100% 13%, 100% 100%, 0 100%)",
                }}
              >
                <div
                  aria-hidden="true"
                ...
                <div className="relative z-10 flex min-h-[860px] flex-col justify-end px-9 pb-12 pt-36 text-center sm:px-11">
              ...
              <article
                className="group relative min-h-[760px] overflow-hidden border-[3px] border-[#708487] bg-[#172022] shadow-[0_34px_95px_rgba(40,57,60,0.28)]"
                style={{
                  clipPath:
                    "polygon(0 10%, 8% 0, 92% 0, 100% 10%, 100% 100%, 0 100%)",
                }}
