...
export interface SurfaceMotionConfiguration {
...
export interface SurfaceConfiguration extends TransformConfiguration {
  ...
  visible?: boolean;
  opacity?: number;
  mediaColor?: number | string;
  depthWrite?: boolean;
  emissive?: number | string;
  intensity?: number;
  material?: Partial<SurfaceMaterialProfile>;
  motion?: SurfaceMotionConfiguration;
}
...
export interface HumanLookConfiguration {
  brightness: number;
  contrast: number;
  saturation: number;
  warmth: number;
...
export interface HumanStageAnchorConfiguration {
  offset?: Vector3Tuple;
...
export interface BorderlessStageConfiguration {
  ...
  motion: {
    architectureResponse: number;
    openingResponse: number;
  };
  human?: HumanStageAnchorConfiguration;
  humanLook?: Partial<HumanLookConfiguration>;
}
...
export interface ArchitectureConfiguration {
  ...
  structuralDetailOpacity: number;
  technicalCeilingOpacity: number;
  projectionGlowIntensity: number;
