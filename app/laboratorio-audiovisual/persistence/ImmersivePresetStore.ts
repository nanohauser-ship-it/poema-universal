...
export interface ImmersivePresetSurface {
  ...
  media?: Blob;
  /** Compatibilidad con experiencias guardadas antes del compositor temático. */
  video?: Blob;
}
