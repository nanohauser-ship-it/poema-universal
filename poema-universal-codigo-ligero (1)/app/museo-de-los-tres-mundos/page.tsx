...
export default function MuseumPage() {
  return (
    <main className="min-h-screen bg-[#07080a] text-[#f0e8dc]">
      ...
      <section className="relative overflow-hidden border-t border-white/10 bg-[#08090b]">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0"
          style={{
            background:
              "radial-gradient(circle at 77% 28%, rgba(199,164,103,0.11), transparent 28%), radial-gradient(circle at 22% 72%, rgba(95,117,132,0.10), transparent 32%)",
          }}
        />

        <div className="relative mx-auto grid max-w-[1550px] gap-16 px-5 py-24 sm:px-8 sm:py-32 lg:grid-cols-[0.75fr_1.25fr] lg:px-12">
          <div>
            <p className="text-[8px] uppercase tracking-[0.44em] text-[#c7a467]">
              Sala documental
            </p>

            <h2 className="mt-7 max-w-xl font-serif text-5xl leading-[0.92] tracking-[-0.055em] sm:text-7xl">
              Archivo de
            ...
            <p className="mt-8 max-w-xl font-serif text-2xl leading-9 text-white/58">
              Veinticuatro imágenes nacidas alrededor de las tres novelas.
            </p>
          </div>

          <div className="flex flex-col justify-between gap-12 border-l border-white/10 pl-0 lg:pl-14">
            <p className="max-w-2xl text-sm leading-8 text-white/40">
              Ocho fotografías por cada mundo. Escenas, cuerpos,
              lugares y reliquias reunidos como memoria visual
              del tríptico.
            </p>

            <div className="grid max-w-2xl grid-cols-3 gap-5">
              <div className="border-t border-white/14 pt-5">
                <strong className="block font-serif text-4xl text-white/74">
                  24
                </strong>
                <span className="mt-2 block text-[7px] uppercase tracking-[0.26em] text-white/30">
                  Fotografías
                </span>
              </div>
            ...
            <Link
              ...
              className="inline-flex w-fit items-center gap-4 border border-[#c7a467]/40 px-7 py-4 text-[8px] uppercase tracking-[0.34em] text-[#c7a467] transition hover:border-[#c7a467] hover:bg-[#c7a467]/[0.06]"
            >
