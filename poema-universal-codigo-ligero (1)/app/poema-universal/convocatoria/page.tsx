...
import BabelSubmissionForm from "./BabelSubmissionForm";
const voices = [
  {
    language: "Español",
...
const principles = [
  {
    number: "01",
    title: "No buscamos nombres consagrados",
        ...
        <div className="relative mx-auto grid min-h-[920px] max-w-[1500px] items-center gap-16 px-5 py-24 sm:px-8 lg:grid-cols-[0.78fr_1.22fr] lg:px-12">
          <div className="relative z-20">
            ...
            <p className="mt-10 max-w-xl font-serif text-2xl leading-[1.42] text-[#2f2117]/72 sm:text-3xl">
              No buscamos nombres consagrados.
              Buscamos sesenta voces de todo el mundo que
              todavía no hayan encontrado una casa.
            </p>
