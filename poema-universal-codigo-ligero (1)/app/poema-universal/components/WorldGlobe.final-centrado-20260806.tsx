    ...
    >
      <div className="relative overflow-hidden border border-white/[0.14] bg-[#020609]/80 shadow-[0_50px_140px_rgba(0,0,0,0.55)]">
          <div className="grid lg:grid-cols-[400px_minmax(0,1fr)]">
            ...
            <div
              ref={containerRef}
              className="relative h-[560px] min-h-[560px] overflow-hidden sm:h-[640px] sm:min-h-[640px] lg:h-[710px] lg:min-h-[710px]"
            >
              {isLoadingCountries && (
            ...
            <aside className="relative col-span-full flex min-h-[300px] max-h-[330px] flex-col overflow-hidden border-t border-white/10 bg-[#050a0e]/95 p-7 lg:p-8">
              ...
              {selectedCountry ? (
                ...
                <div className="flex flex-1 flex-col">
                  <div className="grid min-h-0 flex-1 grid-cols-2 gap-x-7 overflow-y-auto pr-2 sm:grid-cols-3 lg:grid-cols-5 [scrollbar-color:rgba(215,182,111,0.35)_transparent] [scrollbar-width:thin]">
                    {participatingCountries.map(
                      (country) => (
                        <button
                          ...
                          className="group flex w-full items-center justify-between border-b border-white/[0.08] py-3 text-left"
                        >
                          <span className="font-serif text-base text-white/78 transition group-hover:text-white">
                            {country.name}
                          </span>
