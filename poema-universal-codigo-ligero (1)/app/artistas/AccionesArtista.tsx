      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        >
          <span className="flex items-center justify-center gap-2">
            <span className="text-lg font-bold text-[#c63f4b] drop-shadow-[0_0_7px_rgba(198,63,75,0.35)]">♥</span>
            <span className="font-medium text-[#b43f48]">
              {cargando === "corazon"
                ? "Enviando..."
                : `Corazón · ${corazones}`}
            </span>
        ...
        >
          <span className="flex items-center justify-center gap-2">
            <span className="text-lg text-[#c98a25] drop-shadow-[0_0_7px_rgba(201,138,37,0.35)]">🕯</span>
            <span className="font-medium text-[#9a681d]">
              {cargando === "vela"
                ? "Encendiendo..."
                : `Vela · ${velas}`}
            </span>
