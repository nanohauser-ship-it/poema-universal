...
export default function LiveCameraPanel({
  ...
  function startVoiceMeter(
    ...
    const tick = () => {
      ...
      /*
       * El analizador funciona a frecuencia de render.
       * No necesitamos provocar un render React por
       * cada muestra de audio.
       */
      const stableLevel =
        Math.round(normalized * 50) / 50;

      setVoiceLevel((current) =>
        Math.abs(current - stableLevel) >= 0.02
          ? stableLevel
          : current,
      );
