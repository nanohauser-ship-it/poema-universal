        ...
        <header className={styles.birthHeader}>
          <div>
            ...
            <div>
              ...
              <h1>ORGANISMO V4.8.1</h1>
            </div>
          </div>
          <p>Alimentación verbal · Rotación anatómica</p>
        </header>
  ...
  return (
    <main className={styles.page}>
      ...
      <footer className={styles.footer}>
        <span>ORGANISMO V4.8.1 · ALIMENTACIÓN VERBAL · ROTACIÓN VIVA</span>
        <span>
