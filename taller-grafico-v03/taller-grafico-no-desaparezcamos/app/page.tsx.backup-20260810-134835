...
export default function Home() {
  ...
  useEffect(() => {
    // almacenamiento de láminas migrará a IndexedDB
  }, [plates]);
  // La arquitectura completa no se guarda en localStorage:
  // manuscritos grandes exceden su cuota. Se migrará a IndexedDB.
  // Los párrafos completos no se guardan en localStorage.
  // El manuscrito completo no se guarda en localStorage.
  useEffect(() => {
