...
export default function PoemaUniversal2026Page() {
  ...
  const fechaPresentacion = useMemo(() => {
    return new Date("2027-01-01T00:00:00+01:00").toLocaleDateString("es-ES", {
      day: "numeric",
      month: "long",
      year: "numeric",
    });
          ...
          {!tiempo ? (
            <div className="text-center">
              ...
              <p className="mx-auto mt-7 max-w-2xl text-sm leading-8 text-stone-600">
                La puerta anual está calculando el tiempo que falta para abrirse.
              </p>
            </div>
          ) : tiempo.terminado ? (
            <div className="text-center">
