          ...
          <div className="mt-5 border-t border-white/10 pt-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="border border-white/10 px-2 py-2.5 text-[6px] uppercase tracking-[0.18em] text-white/40 transition enabled:hover:border-white/30 enabled:hover:text-white disabled:cursor-default disabled:opacity-20"
              >
                ← Anterior
              </button>
              ...
              <button
                ...
                className="border border-white/10 px-2 py-2.5 text-[6px] uppercase tracking-[0.16em] text-white/40 transition enabled:hover:border-white/30 enabled:hover:text-white disabled:cursor-default disabled:opacity-20"
              >
                Inicio
              </button>
