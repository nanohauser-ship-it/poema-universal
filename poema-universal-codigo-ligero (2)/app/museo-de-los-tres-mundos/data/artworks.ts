...
export const museumArtworks: MuseumArtwork[] = [
  {
    id: "bajo-el-arbol-blanco",
    room: "desaparezcamos",
    number: "I · 01",
    title: "Bajo el Árbol Blanco",
    subtitle: "La muerte que se convirtió en origen",
    curatorialText:
      "Alejandro sostuvo a María mientras el mundo, alrededor de ellos, comenzaba a desaparecer.",
    chapter: "El Árbol Blanco",
    imageUrl: "/museo/desaparezcamos/maria-bajo-el-arbol-blanco.JPG",
    aspect: "landscape",
    accent: "#d7b477",
    background:
  ...
  {
    id: "alejandro-y-francisco",
    room: "desaparezcamos",
    number: "I · 02",
    title: "Alejandro y Francisco",
    subtitle: "Antes de que el mundo los separara",
    curatorialText:
      "Fueron amigos antes de comprender que la memoria también puede convertirse en una forma de resistencia.",
    chapter: "La infancia",
    imageUrl: "/museo/desaparezcamos/alejandro-y-francisco.JPG",
    aspect: "landscape",
    accent: "#b79162",
    background:
  ...
  {
    id: "maria-y-alejandro",
    room: "desaparezcamos",
    number: "I · 03",
    title: "María y Alejandro",
    subtitle: "El instante anterior a la pérdida",
    curatorialText:
      "Todavía podían mirarse sin saber que aquella intimidad acabaría sosteniendo una novela entera.",
    chapter: "La promesa",
    imageUrl: "/museo/desaparezcamos/maria-y-alejandro.JPG",
    aspect: "landscape",
    accent: "#c29c6b",
    background:
  ...
  {
    id: "el-teatro-de-la-jerarquia",
    room: "jerarquia",
    number: "II · 01",
    title: "El teatro de la Jerarquía",
    subtitle: "Dos cuerpos ante una estructura que ya había decidido por ellos",
    curatorialText:
      "La Jerarquía no necesitaba hablar. Bastaba con construir el escenario y esperar a que cada uno ocupara su lugar.",
    chapter: "El escenario",
    imageUrl: "/museo/jerarquia/teatro-de-la-jerarquia.JPG",
    aspect: "landscape",
    accent: "#a65c48",
    background:
  ...
  },
  {
    ...
    number: "II · 02",
    title: "El Entredós",
    subtitle: "El cuerpo dividido entre lo que entrega y lo que conserva",
    curatorialText:
      "Entre ambos permanecía aquello que ninguno podía poseer sin perder una parte de sí mismo.",
    chapter: "El Entredós",
    imageUrl: "/museo/jerarquia/el-entredos.JPG",
    aspect: "landscape",
    accent: "#b48758",
    background:
      "radial-gradient(circle at 48% 72%, rgba(180,135,88,0.35), transparent 18%), linear-gradient(145deg, #25211e, #070708)",
    symbol: "◐",
  },
  {
    id: "la-mesa-y-las-tres-cruces",
    room: "jerarquia",
    number: "II · 03",
    title: "La mesa y las tres cruces",
    subtitle: "El hambre convertida en doctrina",
    curatorialText:
      "Sobre la mesa solo quedaba un cuenco vacío. Al fondo, tres cruces sostenían el orden de quienes todavía podían comer.",
    chapter: "La doctrina del hambre",
    imageUrl: "/museo/jerarquia/la-mesa-y-las-tres-cruces.JPG",
    aspect: "landscape",
    accent: "#8f4436",
    background:
...
{
    id: "el-laberinto-de-ciudad-b",
    room: "bielka",
    number: "III · 01",
    title: "El laberinto de Ciudad B",
    subtitle: "La ciudad construida alrededor de una única puerta",
    curatorialText:
      "Nadie sabía si el laberinto protegía la ciudad del centro o protegía el centro de quienes aún vivían en ella.",
    chapter: "La ciudad y el laberinto",
    imageUrl: "/museo/bielka/laberinto.JPG",
    aspect: "portrait",
    accent: "#b9dce2",
    background:
  ...
  },
  {
    ...
    chapter: "Tránsito",
    imageUrl: "/museo/bielka/el-carro-de-paja.JPG",
    aspect: "landscape",
    accent: "#c6a96e",
    background:
...

  {
    ...
    imageUrl: "/museo/coleccion/no-desaparezcamos/el-exiliado.webp",
    symbol: "↗",
  },
  {
    id: "la-promesa",
    ...
    imageUrl: "/museo/coleccion/no-desaparezcamos/la-promesa.webp",
    symbol: "∞",
  },
  {
    id: "el-arbol-blanco",
    ...
    imageUrl: "/museo/coleccion/no-desaparezcamos/el-arbol-blanco.webp",
    symbol: "Y",
  },

  {
    ...
    imageUrl: "/museo/coleccion/jerarquia/la-cadena-rota.webp",
    symbol: "⌁",
  },
  {
    ...
    imageUrl: "/museo/coleccion/jerarquia/la-cocina-sin-fuego.webp",
    symbol: "△",
  },
  {
    ...
    imageUrl: "/museo/coleccion/jerarquia/los-perros-encadenados.webp",
    symbol: "••",
  },

  {
    ...
    imageUrl: "/museo/coleccion/bielka/el-corazon-de-dos-mitades.webp",
    symbol: "♡",
  },
  {
    ...
    room: "bielka",
    number: "III · 05",
    title: "Elvira y la escuela de las letras en el aire",
    ...
    imageUrl: "/museo/coleccion/bielka/la-entrada-al-laberinto.webp",
    symbol: "⌑",
  },
  {
    ...
    imageUrl: "/museo/bielka/cofradia-del-gato.png",
    symbol: "≈",
  },
];
