...
export function buildControlledSymbolicImpulses(
  ...
  candidates = candidates.filter((impulse) => {
    ...
    // V6.2.1: RELACIONAL es el campo abierto de trabajo. Si una palabra aún
    // no posee nodo documental directo, sus rutas remotas siguen disponibles
    // y permanecen claramente marcadas como experimentales.
    return true;
  });
